...
class EISelection(BaseSelectionStrategy):
    """
...
class PISelection(BaseSelectionStrategy):
    """
...
class UCBSelection(BaseSelectionStrategy):
    """
...
class ThompsonSamplingSelection(BaseSelectionStrategy):
    """
